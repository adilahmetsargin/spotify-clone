...
const Icon = ({ name, size = 24 }) => {
  const icons = {
    ...
    pauseIcon: PauseIcon,
    playerPrevIcon: PlayerPrevIcon,
    playerNextIcon: PlayerNextIcon,
    shuffleIcon: ShuffleIcon,
    repeatIcon: RepeatIcon,
    queueIcon: QueueIcon,
    deviceIcon: DeviceIcon,
    fullScreenIcon: FullScreenIcon,
    fullScreenOffIcon: FullScreenOffIcon,
    pictureInPictureIcon: PictureInPictureIcon,
    volumeMutedIcon: VolumeMutedIcon,
    volumeLowIcon: VolumeLowIcon,
    volumeNormalIcon: VolumeNormalIcon,
    volumeFullIcon: VolumeFullIcon,
